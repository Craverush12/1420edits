      ...
      {/* <section ref={packsRef} id="packs-section" className="py-16 bg-[#0a0a0a]">
        <div className="mx-auto max-w-7xl px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-500 uppercase tracking-wider">PREMIUM T-SHIRTS</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            {[
              {
                id: "tshirt-1",
                title: "Desi Bass Classic",
                image: "https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?w=800&h=800&fit=crop",
                price: 899
              },
              {
                id: "tshirt-2",
                title: "Underground Edition",
                image: "https://images.unsplash.com/photo-1594938291221-94f18b46f48a?w=800&h=800&fit=crop",
                price: 999
              }
            ].map((tshirt, index) => (
              <div 
